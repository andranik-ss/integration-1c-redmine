...
Процедура ОсновныеДействияФормыОсновныеДействияФормыВыполнить(Кнопка)
	...
	Оповестить("ОбновитьСписокЗадач", ЗадачаНомер, "ФормаЗадачи");
...
Процедура ПриОткрытии()
	...
	Если НоваяЗадача Тогда
		...
		ЗаполнитьСписокНастраиваемыхПолей();
	Иначе
...
Процедура ЗаполнитьСписокНастраиваемыхПолей()
	...
	Для Каждого Поле Из Данные["custom_fields"] Цикл
		...
		КонецЕсли;
	КонецЦикла;
	мНастраиваемыеПоля.Сортировать("Имя");
