...
Процедура КоманднаяПанель1ПрикрепитьФайлы(Кнопка)
	...
	Если ДиалогВыбора.Выбрать() Тогда
		...
		ОбщегоНазначения.ЗагрузитьВТаблицуЗначений(ТаблицаВложений, Вложения);	
